<template>
  <div>
    <b-navbar toggleable="lg" type="dark" variant="primary" class="p-3">
      <b-navbar-brand to="/">
        <svg
          version="1.1"
      ...
      <b-collapse id="nav-collapse" is-nav class="justify-content-center">
        <b-navbar-nav class="text-center" style="column-gap: 2rem;">
          <b-nav-item to="/vuelos">Buscar vuelos</b-nav-item>
          <b-nav-item :to="$store.state.busqueda ? '/resultados-vuelos' : '#'"
            >Resultados de búsqueda</b-nav-item
          >
        </b-navbar-nav>
      </b-collapse>
    </b-navbar>
